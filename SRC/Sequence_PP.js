    //1. to get single digit random function
    let num = Math.floor(Math.random()*10);
    console.log("Single Random :"+num);

    //2. to get random dice num
    let dice = Math.floor(Math.random()*10)%6 +1;
    console.log("Single Dice :"+dice);

    //3. Adding two random dice and printing result
    ...
    //4. Reads 5, 2 digits random number and to find average of random number
    let a = 5;
    result = 0;
    for(let i=0;i<a;i++)
    {
